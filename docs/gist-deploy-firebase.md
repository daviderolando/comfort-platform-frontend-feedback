...
# Public directory: Specify the directory where your Angular app's build artifacts are located (e.g., `dist/your-app-name`, e.g., `dist/frontend/browser`).
  # NB: In case of PWA the public dist folder generated is `dist/frontend/browser`
